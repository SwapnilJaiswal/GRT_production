...
<body dir="LTR">
  ...
  <form id="cuesLoginForm" method="post" onsubmit="cuesShowLoginProgressMessage();return true;" action="CEC_Login"><table class="cuesLoginContainer" border="0" cellpadding="0" cellspacing="0"><tbody><tr height="100%"><td valign="top"><div id="cuesLoginProductSection" class="cuesLoginProductSection" style="left: 255.5px; top: 222px;"><br class="cuesLoginClear"><table><tbody><tr><td valign="top" style="padding-bottom:5px"><img class="cuesLoginLogo" onload="cuesFixPNG(null,this)" src="/sat_tool_test/cues_images/cisco_logo_header.png" align="absmiddle" title="Cisco" alt="Cisco"></td><td valign="top">
    ...
    <tr><td colspan="2" class="cuesBrSmall">&nbsp;</td></tr><tr><td>&nbsp;</td><td nowrap="yes"><button id="cuesLoginSubmitButton" type="submit" class="cuesLoginButton">Log In</button>&nbsp;&nbsp;<img id="cuesLoginProgress" style="visibility:hidden;" alt="" title="" src="/sat_tool_test/cues_images/login_progress.gif"></td></tr><tr><td>&nbsp;</td><td>
    ...
    <div class="cuesLoginCopyright">
  		©2008-2009, Cisco Systems, Inc. All rights rights reserved. 
    </div>
